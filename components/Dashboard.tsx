...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 lg:space-y-10 p-2 pb-20 animate-in fade-in duration-500">
      <div className="flex justify-between items-center bg-white p-6 lg:p-8 rounded-[32px] lg:rounded-[40px] border border-slate-200 shadow-sm">
         <div className="flex items-center gap-4 lg:gap-5">
            <div className="bg-emerald-500 p-3 lg:p-4 rounded-xl lg:rounded-2xl text-white shadow-lg shadow-emerald-100"><TrendingUp size={20}/></div>
            <div>
               ...
               <div className="flex items-center gap-2.5 mt-1 lg:mt-1.5 bg-slate-50 px-2.5 py-1 rounded-full w-fit border border-slate-100">
         ...
         <button onClick={loadData} className="p-3 bg-slate-50 text-slate-400 hover:text-indigo-600 rounded-xl transition border border-transparent hover:border-slate-200 active:scale-95"><RefreshCw size={18}/></button>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-7 gap-4 lg:gap-6">
        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-emerald-500 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-emerald-100 w-fit"><Users size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Membres</h3>
          <p className="text-xl lg:text-4xl font-black italic text-emerald-600 tracking-tighter leading-none">{totalMembers}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-indigo-600 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-indigo-100 w-fit"><Activity size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Leads</h3>
          <p className="text-xl lg:text-4xl font-black italic tracking-tighter text-indigo-600 leading-none">{totalLeads}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-violet-600 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-violet-100 w-fit"><Calendar size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">RDV</h3>
          <p className="text-xl lg:text-4xl font-black italic text-violet-600 tracking-tighter leading-none">{campaignStats.meetings}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-fuchsia-600 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-fuchsia-100 w-fit"><Zap size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Pistes</h3>
          <p className="text-xl lg:text-4xl font-black italic text-fuchsia-600 tracking-tighter leading-none">{campaignStats.positive}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-rose-500 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-rose-100 w-fit"><UserX size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Refus (NON)</h3>
          <p className="text-xl lg:text-4xl font-black italic text-rose-600 tracking-tighter leading-none">{campaignStats.negative}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-slate-400 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-slate-200 w-fit"><HelpCircle size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Incertains</h3>
          <p className="text-xl lg:text-4xl font-black italic text-slate-600 tracking-tighter leading-none">{campaignStats.nsp}</p>
        </div>

        <div className="bg-white p-5 lg:p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="p-3 bg-amber-500 text-white rounded-xl mb-4 lg:mb-6 shadow-lg shadow-amber-100 w-fit"><Ticket size={20}/></div>
          <h3 className="text-[8px] lg:text-[11px] font-bold uppercase text-slate-400 tracking-widest mb-1">Salon</h3>
          <p className="text-xl lg:text-4xl font-black italic text-amber-500 tracking-tighter leading-none">{campaignStats.registered}</p>
        </div>
      </div>
